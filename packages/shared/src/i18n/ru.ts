...
export const ru: Messages = {
  ...
  'library.emptyBody': 'Набор хранит слова. Набор внутри набора это то, что все остальные называют папкой.',
  ...
  'library.deleteBody': 'Он и всё внутри перестанут участвовать в повторениях. Ничего не стирается тридцать дней, так что это можно отменить.',
  ...
  'note.typeChangeBody': 'Это удалит карточек: {cards}, и ответов на них: {reviews}. Остальное в записи останется.',
  ...
  'note.deleteBody': 'Запись и её карточки перестанут участвовать в повторениях. Ничего не стирается тридцать дней, так что это можно отменить.',
  ...
  'notes.bulkDeleteBody': 'Они и их карточки перестанут участвовать в повторениях. Ничего не стирается тридцать дней, так что это можно отменить.',
  ...
  'import.title': 'Импорт',
  'import.subtitle': 'Вставь список или загрузи файл. Ничего не запишется, пока ты не увидишь, что получится.',
  ...
  'import.undoBody': 'Всё, что добавил этот импорт, перестанет участвовать в повторениях, вместе с карточками.',
  ...
  'import.tooManyProblems': 'Строки без обязательных полей не импортируются. Поправь их в файле и прочитай список заново.',
