...
export const ru: Messages = {
  ...
  'import.duplicateAll': 'Для каждого совпадения',
  'import.resolve.skip': 'Пропустить',
  'import.resolve.merge': 'Дополнить пустые поля в том, что есть',
  ...
  'import.undoBody':
    'Всё, что добавил этот импорт, перестанет участвовать в повторениях, вместе с карточками.',
  'import.undoReviewed': 'На эти карточки уже дано ответов: {count}. Эта история уйдёт с ними.',
