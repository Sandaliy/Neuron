...
export const en = {
  ...
  'library.deleted': 'Deck deleted: {name}',
  'library.undo': 'Undo',
  ...
  'deleted.parentRequired': 'Restore its original parent deck first.',
  'deleted.deckRequired': 'Restore the original deck chain first.',
  'deleted.unknownDeck': 'Original deck unavailable',
  'deleted.decksEmptyTitle': 'No deleted decks',
  'deleted.decksEmptyBody': 'Deleted decks will appear here while they can still be restored.',
  ...
  'deleted.deckRestored': '{name} restored',
  ...
  'import.useExample': 'Replace the list with this example',
  'import.generatedPreview': 'Cards from the first valid note',
  'import.supportedFields': 'Supported fields and richer notes',
  'import.structuredHelp':
    'Word notes: word and translation are required. Question notes: front and back. Gap text: text with a hidden part. Optional text fields, tags and grammar enrich a word note. The names below can be used as table headings or JSON keys. Arbitrary custom fields are not imported; put extra text in note.',
  'import.grammarHelp':
    'JSON grammar supports article, plural, gender (m/f/n), praeteritum, partizip2, auxiliary (haben/sein), separable, case (accusative/dative/genitive), reflexive, comparative, superlative, variant (BrE/AmE), irregular and uncountable. Use true/false for separable, reflexive and uncountable. Part of speech: noun, verb, adjective, adverb, phrase or other. Tables support article and plural.',
  'import.mediaLater':
    'Available now: text, JSON, structured text fields and Anki text export. Later: direct .apkg and media/image import. Images and audio are not imported from these files.',
  'import.clozeHelp':
