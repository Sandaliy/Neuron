...
export const en = {
  ...
  'practice.pool': '{count} of {total} notes have both fields.',
  ...
  'practice.cleared': '100% cleared this practice run',
  ...
  'study.mixed': 'All scheduled directions',
  'study.recognition': 'Recognition: word → meaning',
  'study.recall': 'Recall: meaning → word',
  ...
  'import.partOfSpeechHelp':
    'partOfSpeech: noun, verb, adjective, adverb, phrase or other. Tables support article and plural.',
