...
export const GERMAN_LESSON_ONE: readonly GermanWord[] = [
  {
    ...
    partOfSpeech: 'noun',
    example: 'Er arbeitet mit großer Sorgfalt.',
  },
  {
    term: 'Schlüssel',
    article: 'der',
  ...
  },
  {
    ...
    translation: 'relationship, ratio',
    partOfSpeech: 'noun',
  },
  {
    term: 'Vorschlag',
  ...
  },
  {
    ...
    partOfSpeech: 'noun',
    example: 'Das war keine leichte Entscheidung.',
  },
  {
    term: 'Gespräch',
    article: 'das',
...
export const GERMAN_LESSON_TWO: readonly GermanWord[] = [
  ...
  },
  {
    ...
    article: 'die',
    plural: 'die Anlagen',
    translation: 'facility, attachment',
    partOfSpeech: 'noun',
  },
  {
    term: 'Vermögen',
    article: 'das',
    plural: 'die Vermögen',
    translation: 'assets, ability',
    partOfSpeech: 'noun',
  },
  {
    term: 'erledigen',
    translation: 'to get done, to handle',
    partOfSpeech: 'verb',
    example: 'Ich muss noch zwei Sachen erledigen.',
  },
...
export const ENGLISH_WORDS: readonly EnglishWord[] = [
  ...
  {
    term: 'tentative',
    translation: 'предварительный, осторожный',
    rank: 3196,
    partOfSpeech: 'adjective',
  },
  ...
  {
    term: 'contingent',
    translation: 'зависящий от обстоятельств',
    rank: 3468,
    partOfSpeech: 'adjective',
  },
...
export const BASIC_NOTES: readonly { readonly front: string; readonly back: string }[] = [
  {
    front: 'What does the stability of a card measure?',
    back: 'The number of days until the chance of recalling it falls to the target retention.',
  },
  {
    front: 'What does difficulty measure in FSRS?',
    back: 'How hard one particular card is for one particular person, on a scale of 1 to 10.',
  },
  {
    front: 'What is retrievability?',
    back: 'The probability of recalling a card right now, computed from its stability and the time since the last review.',
  },
  {
    front: 'Why is a note not the same thing as a card?',
    back: 'A note is the fact. A card is one direction of asking about it, and each direction is scheduled on its own.',
  },
  {
    front: 'What is the Fisher equation used for?',
    back: 'Relating nominal interest rates, real interest rates and inflation.',
  },
];
