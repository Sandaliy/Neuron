...
import { manyDecks, manyNotes, useFixtures, usePreferences } from './fixtures';
 ...
 *
 * Five thousand rows, and the whole point of the screen is that five thousand
 * of them are never in the document at once. Without the virtualiser the
 * browser lays out five thousand elements on every frame of a scroll, and the
